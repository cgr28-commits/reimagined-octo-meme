  ...
  const enriched = await Promise.all(
    bookings.map(async (booking) => {
      ...
      return {
        ...
        outboundTrackingToken: outboundJob?.token,
        returnTrackingToken: returnJob?.token,
        cancelledLegs: booking.cancelledLegs,
        outboundCancelledAt: booking.outboundCancelledAt,
        returnCancelledAt: booking.returnCancelledAt,
        calendarEventIdsByLeg: booking.calendarEventIdsByLeg,
