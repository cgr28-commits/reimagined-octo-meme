...
export default function HeroSlideshow() {
  ...
  return (
    <section className="relative min-h-screen max-w-full overflow-x-clip overflow-y-hidden pt-36 md:pt-28">
      ...
      <div className="relative mx-auto grid w-full min-w-0 max-w-7xl grid-cols-1 gap-8 px-4 py-5 sm:px-6 md:gap-12 md:px-6 md:py-16 lg:max-w-[1400px] lg:grid-cols-[minmax(0,1fr)_minmax(500px,600px)] lg:items-start lg:gap-14 lg:px-10 lg:py-14 xl:gap-16 xl:px-12 xl:py-16">
        ...
        <div
          className="order-1 min-w-0 w-full scroll-mt-36 md:scroll-mt-28 xl:scroll-mt-28 lg:order-2 lg:justify-self-stretch"
          id="quote"
        >
