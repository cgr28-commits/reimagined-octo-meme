...
export default function HeroSlideshow() {
  return (
    <section className="homepage-hero relative min-h-screen max-w-full overflow-x-clip overflow-y-hidden pt-[4.15rem] md:pt-28">
      ...
      <div className="relative mx-auto grid w-full min-w-0 max-w-7xl grid-cols-1 gap-2 px-4 py-2 sm:px-6 md:gap-12 md:px-6 md:py-16 lg:max-w-[1400px] lg:grid-cols-[minmax(0,1fr)_minmax(500px,600px)] lg:items-start lg:gap-14 lg:px-10 lg:py-14 xl:gap-16 xl:px-12 xl:py-16">
        <div className="order-1 min-w-0 md:order-2 lg:order-1 lg:pt-2">
          ...
          <p className="mt-2 max-w-xl text-pretty text-[0.94rem] leading-[1.42] text-white/82 md:mt-5 md:text-lg md:leading-relaxed lg:mt-6 lg:text-[1.125rem]">
