        ...
        >
          ...
          <div className="flex max-w-full flex-wrap items-center gap-1.5">
            {MOBILE_QUICK_LINKS.map((link) => {
              const className = `inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold transition-colors ${
            ...
            <a
              ...
              className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white transition-transform hover:scale-[1.03] active:scale-95"
            >
