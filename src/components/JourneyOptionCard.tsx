...
function JourneyIcon({ id }: { id: QuoteJourneyIntent }) {
  ...
  if (id === "from-airport") {
    return (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        <path d="M2.5 19h19v2h-19v-2z" />
        <path d="M19.57 5.64c-.22-.8-1.04-1.27-1.84-1.06L8 8.43 6.95 9.49l3.54 6.47-7.19 1.76-1.94-1.57-1.38.75L3.5 20.5l11.37-2.47 6.64-9.87c.31-.46.21-1.09-.25-1.4-.22-.15-.47-.2-.69-.12z" />
      </svg>
    );
  }
  return (
