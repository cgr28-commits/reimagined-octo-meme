    ...
    >
      <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:items-center lg:gap-6">
        <div className="min-w-0 text-center lg:text-left">
          ...
          {estateDueToLuggage ? (
            <p className="mt-1.5 text-xs font-medium text-[#475569]">Extra luggage space for your journey</p>
          ) : null}
        </div>
        ...
        <div className="mt-4 min-w-0 text-center lg:mt-0 lg:text-left">
          ...
          <p className="mt-2.5 text-xs font-medium leading-snug text-[#475569]">
            🔒 Secure booking · Takes around 2 minutes
          </p>

          <ul className="mt-3 grid grid-cols-3 gap-2 text-center text-xs font-medium leading-snug text-navy">
            <Benefit icon="card">
              {capacityConfirmation ? "We'll confirm first" : "Secure payment"}
              <span className="mt-0.5 block break-words text-[0.8125rem] font-medium leading-snug text-[#475569]">
      ...
      <p className="mt-3 text-center text-xs font-medium leading-snug text-[#475569] lg:mt-4">
