    ...
    <section id="tours" className="relative py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          description="Beyond airport transfers, we offer private chauffeur day trips — we take you door-to-door from the Causeway Coast to Belfast, the Mournes, and beyond."
        />
        ...
        <div className="mt-12 grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col items-center gap-6 sm:items-start">
            ...
            <p className="max-w-md text-center text-sm text-white/50 sm:text-left">
              Giant&apos;s Causeway, Game of Thrones locations, Belfast city highlights, and more — all with door-to-door transport.
            </p>
          </div>
        </div>
      </div>
