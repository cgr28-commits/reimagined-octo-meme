...
/**
 * Full Express Drop-Off control for the initial quote, or a compact
      ...
      >
        <div className="flex min-w-0 flex-wrap items-start justify-between gap-2">
          <div className="min-w-0 space-y-1 text-sm text-white/85">
            <p className="font-medium text-white">Express Drop-Off</p>
            <p>{expressDropOffBreakdownLabel(airportCode, selected)}</p>
