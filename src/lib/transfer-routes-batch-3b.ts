...
export const TRANSFER_ROUTE_BATCH_3B: TransferRouteContent[] = [
  {
    slug: "carryduff-to-belfast-international",
    townSlug: "carryduff",
    airportCode: "BFS",
    title: "Carryduff to Belfast International Airport Taxi",
    h1: "Carryduff to Belfast International Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "This Carryduff–Aldergrove page is the Saintfield Road booking, priced from your street rather than from a Lisburn or Newtownabbey pin.",
    localAreasText:
      "The roundabout, Cairnshill, Knockbracken, Four Winds and Newtownbreda are different starts. Saintfield is further down the A24. Moneyreagh is the Comber side.",
    faqs: [
      {
        question: "How much is a taxi from Carryduff to Belfast International Airport?",
        answer:
          "Belfast International is already selected in the quote box. Enter the roundabout side, Cairnshill or Saintfield — those pins are not one Carryduff fare.",
      },
      {
        question: "How long does Carryduff to Belfast International take?",
        answer:
          "The usual start is the Saintfield Road through south Belfast, then the motorway west. The quote tool maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Aldergrove to Carryduff?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Share the flight number. We monitor it where possible and adjust the Carryduff collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Do you collect from Saintfield for this airport?",
        answer:
          "Yes, when Saintfield is the address. It is further down the A24 than the Carryduff roundabout and should be entered as Saintfield.",
      },
      {
        question: "Can I book this Carryduff transfer online?",
        answer:
  ...
  {
    slug: "carryduff-to-belfast-city-airport",
    townSlug: "carryduff",
    airportCode: "BHD",
    title: "Carryduff to Belfast City Airport Taxi",
    h1: "Carryduff to Belfast City Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "City Airport from Carryduff is the south-to-east city booking — a reserved driver and a fixed price from the Saintfield Road, not a Shore Road fare.",
    localAreasText:
      "Four Winds and Newtownbreda sit closer to the city crossing than Saintfield. Cairnshill and Knockbracken should be named. Moneyreagh is toward Comber.",
    faqs: [
      {
        question: "How much is a taxi from Carryduff to Belfast City Airport?",
        answer:
          "Use the quote tool on this page. City Airport is already selected. Four Winds and Saintfield are different starts, so we do not print one Carryduff fare for this terminal.",
      },
      {
        question: "How long is Carryduff to Belfast City Airport?",
        answer:
          "The usual path leaves the Saintfield Road and crosses toward Sydenham. It is not the Holywood A2. The quote box shows the time for your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from City Airport to Carryduff?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Yes. Enter the Knockbracken street. It is a Carryduff-area pickup, not a city-centre hotel pin.",
      },
      {
        question: "Can I book online from Carryduff?",
        answer:
  ...
  {
    slug: "carryduff-to-dublin-airport",
    townSlug: "carryduff",
    airportCode: "DUB",
    title: "Carryduff to Dublin Airport Taxi",
    h1: "Carryduff to Dublin Airport Taxi",
    metaDescription:
    ...
    fromAirport:
      "Dublin Airport → Carryduff is booked as a return or a one-way inbound. We monitor the flight where possible. Complimentary waiting on airport pickups is up to 60 minutes. Share the terminal when you know it.",
    whyBookIntro:
      "A Carryduff–Dublin transfer is a reserved A1 booking from the south of Belfast, with included tolls and a fare taken from your street.",
    localAreasText:
      "The roundabout and Cairnshill reach the main road first. Saintfield is down the A24. Moneyreagh is toward Comber. Four Winds and Newtownbreda are the Belfast side.",
    faqs: [
      {
        question: "How much is a taxi from Carryduff to Dublin Airport?",
        answer:
          "Dublin Airport is already selected. Enter the Carryduff or Saintfield street in the quote tool. Applicable M1 tolls are included. We do not publish one south-Belfast price.",
      },
      {
        question: "How long does Carryduff to Dublin Airport take?",
        answer:
          "This is the long southbound booking after the Saintfield Road, on the A1/M1. The quote tool maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book Dublin Airport back to Carryduff?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Give us the flight number. We monitor it where possible and adjust the Carryduff collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Are tolls included from Carryduff to Dublin?",
        answer:
          "Yes. Applicable M1 tolls are included in the Dublin Airport fare the quote tool shows.",
      },
      {
        question: "Can I book an early Dublin pickup in Carryduff?",
        answer:
          "Yes. Overnight pickups from Carryduff, Saintfield and Moneyreagh are booked on this form.",
      },
    ],
  },
  {
    slug: "hillsborough-to-belfast-international",
    townSlug: "hillsborough",
    airportCode: "BFS",
    title: "Hillsborough to Belfast International Airport Taxi",
    h1: "Hillsborough to Belfast International Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "This Hillsborough–Aldergrove page is quoted from the village or Culcavy address you enter, not from Lisburn town centre.",
    localAreasText:
      "The bypass, the village streets, Culcavy and Annahilt are different starts. Dromore is further south on the A1. Moira is a separate village on the M1.",
    faqs: [
      {
        question: "How much is a taxi from Hillsborough to Belfast International Airport?",
        answer:
          "The quote box already has Belfast International selected. A village street and the A1 bypass are different Hillsborough pins, so we do not publish one fare.",
      },
      {
        question: "How long does Hillsborough to Belfast International take?",
        answer:
          "The usual line is the A1 toward Sprucefield, then the M1 and M2/M22. The quote tool maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Aldergrove to Hillsborough?",
        answer:
          "Yes. Choose Return on the quote form. Where an instant online price is shown, a 5% discount applies to the combined fare.",
      },
      {
        ...
        answer:
          "Share the flight number. We monitor it where possible and adjust the Hillsborough collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Do you collect from Culcavy?",
        answer:
          "Yes. Enter Culcavy. It sits toward Lisburn and is not the same pin as Hillsborough village.",
      },
      {
        question: "Can I book this Hillsborough transfer online?",
        answer:
          "Yes. Complete the quote on this page and pay securely online where an instant fare is shown.",
      },
    ],
  ...
  {
    slug: "hillsborough-to-belfast-city-airport",
    townSlug: "hillsborough",
    airportCode: "BHD",
    title: "Hillsborough to Belfast City Airport Taxi",
    h1: "Hillsborough to Belfast City Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "City Airport from Hillsborough is the Westlink booking — a fixed price from the village address, not an Aldergrove fare pointed at the wrong terminal.",
    localAreasText:
      "Village streets need the house or hotel name. Culcavy is toward Lisburn. Annahilt is south. The bypass is a different start from either.",
    faqs: [
      {
        question: "How much is a taxi from Hillsborough to Belfast City Airport?",
        answer:
          "Use the quote tool on this page. City Airport is already selected. The village and the bypass are different starts, so there is no single Hillsborough fare.",
      },
      {
        question: "How long is Hillsborough to Belfast City Airport?",
        answer:
          "The usual path is the A1 and M1 into the Westlink, then toward Sydenham. The quote box shows the time for your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from City Airport to Hillsborough?",
        answer:
          "Yes. Use Return on the quote form. Instant online return prices include a 5% discount on the combined fare where that price is shown.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Enter Annahilt. It sits south of Hillsborough village and is not a Lisburn city-centre address.",
      },
      {
  ...
  {
    slug: "hillsborough-to-dublin-airport",
    townSlug: "hillsborough",
    airportCode: "DUB",
    title: "Hillsborough to Dublin Airport Taxi",
    h1: "Hillsborough to Dublin Airport Taxi",
    metaDescription:
    ...
    fromAirport:
      "Dublin Airport → Hillsborough is booked as a return or a one-way inbound. We monitor the flight where possible. Complimentary waiting on airport pickups is up to 60 minutes. Share the terminal when you know it.",
    whyBookIntro:
      "A Hillsborough–Dublin booking is the southbound A1 transfer, with included tolls and a fare taken from the village or bypass address you enter.",
    localAreasText:
      "The village and the bypass are different starts. Culcavy is the Lisburn side. Annahilt and Dromore are south. Name the hotel if you are staying off the A1.",
    faqs: [
      {
        question: "How much is a taxi from Hillsborough to Dublin Airport?",
        answer:
          "Enter the Hillsborough pickup in the quote tool — Dublin Airport is already selected. Applicable M1 tolls are included. The village and the bypass are not one pin, so we do not publish one fare.",
      },
      {
        question: "How long does Hillsborough to Dublin Airport take?",
        answer:
          "This is the southbound A1/M1 booking, longer than either Belfast airport from the village. The quote box maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Dublin Airport to Hillsborough?",
        answer:
          "Yes. Select Return on the quote form. Instant online returns include a 5% combined-fare discount where that price is shown.",
      },
      {
        question: "What if my Dublin flight is delayed?",
        answer:
          "Give us the flight number. We monitor it where possible and adjust the Hillsborough collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Overnight Hillsborough and Culcavy pickups for first-wave Dublin flights are booked on this form.",
      },
    ],
  },
  {
    slug: "moira-to-belfast-international",
    townSlug: "moira",
    airportCode: "BFS",
    title: "Moira to Belfast International Airport Taxi",
    h1: "Moira to Belfast International Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "This Moira–Aldergrove page is the eastbound M1 booking, priced from Main Street, Maghaberry or Aghalee rather than from Lisburn.",
    localAreasText:
      "Main Street, the M1 junction, Maghaberry and Aghalee are different Moira-area starts. Hillsborough is the neighbouring village and has its own pages.",
    faqs: [
      {
        question: "How much is a taxi from Moira to Belfast International Airport?",
        answer:
          "Belfast International is already selected. Enter Main Street, Maghaberry or Aghalee in the quote box — those starts are not one Moira fare.",
      },
      {
        question: "How long does Moira to Belfast International take?",
        answer:
          "The usual path is east on the M1, then the M2/M22. The quote tool maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Aldergrove to Moira?",
        answer:
          "Yes. Choose Return on the quote form. Where an instant online price is shown, a 5% discount applies to the combined fare.",
      },
      {
        question: "What if my Aldergrove flight is delayed?",
        answer:
          "Share the flight number. We monitor it where possible and adjust the Moira collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Do you collect from Maghaberry?",
        answer:
          "Yes. Enter Maghaberry. It sits north of the M1 and is not a Moira Main Street address.",
      },
      {
        question: "Can I book this Moira transfer online?",
        answer:
          "Yes. Complete the quote on this page and pay securely online where an instant fare is shown.",
      },
    ],
  ...
  {
    slug: "moira-to-belfast-city-airport",
    townSlug: "moira",
    airportCode: "BHD",
    title: "Moira to Belfast City Airport Taxi",
    h1: "Moira to Belfast City Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "City Airport from Moira is the Westlink booking from the M1 village — a fixed price for that street, not an Aldergrove fare.",
    localAreasText:
      "Main Street and the motorway junction are different Moira starts. Maghaberry is north of the M1. Aghalee is toward Lough Neagh.",
    faqs: [
      {
        question: "How much is a taxi from Moira to Belfast City Airport?",
        answer:
          "Use the quote tool on this page. City Airport is already selected. Main Street and Maghaberry are different pins north and south of the M1, so we do not print one village fare.",
      },
      {
        question: "How long is Moira to Belfast City Airport?",
        answer:
          "The usual path is the M1 into the Westlink, then toward Sydenham. The quote box shows the time for your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from City Airport to Moira?",
        answer:
          "Yes. Use Return on the quote form. Instant online return prices include a 5% discount on the combined fare where that price is shown.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Enter the Aghalee address. It sits toward Lough Neagh and is not a Hillsborough pickup.",
      },
      {
        question: "Can I book online from Moira?",
        answer:
          "Yes. The calculator is the same booking flow as the homepage, with Belfast City Airport already selected.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        question: "How much is a taxi from Moira to Dublin Airport?",
        answer:
          "Dublin Airport is already selected. Enter Main Street, Maghaberry or Aghalee in the quote tool. Applicable M1 tolls are included. Those three starts are not one Moira price.",
      },
      {
      ...
      },
      {
        question: "What if my Dublin flight is delayed?",
        answer:
          "Give us the flight number. We monitor it where possible and adjust the Moira collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Are tolls included from Moira to Dublin?",
        answer:
          "Yes. Applicable M1 tolls are included in the Dublin Airport fare the quote tool shows.",
      },
      {
        question: "Can I book an early Dublin pickup in Moira?",
        answer:
          "Yes. Overnight pickups from Moira and Maghaberry for first-wave Dublin flights are booked on this form.",
      },
    ],
  },
  {
    slug: "glengormley-to-belfast-international",
    townSlug: "glengormley",
    airportCode: "BFS",
    title: "Glengormley to Belfast International Airport Taxi",
    h1: "Glengormley to Belfast International Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "This Glengormley–Aldergrove page is the Sandyknowes booking, priced from Hightown, Mallusk or Carnmoney rather than from Whiteabbey.",
    localAreasText:
      "Sandyknowes, Hightown Road, Carnmoney, Mallusk and Rathcoole are different starts. Include the house number or the unit. Whiteabbey is a separate Shore Road page.",
    faqs: [
      {
        question: "How much is a taxi from Glengormley to Belfast International Airport?",
        answer:
          "Belfast International is already selected in the quote box. Hightown, Mallusk and Carnmoney are different sides of Sandyknowes, so we do not publish one Glengormley fare.",
      },
      {
        question: "How long does Glengormley to Belfast International take?",
        answer:
          "The usual path joins the M2 at Sandyknowes and continues toward Aldergrove. The quote tool maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Aldergrove to Glengormley?",
        answer:
          "Yes. Choose Return on the quote form. Where an instant online price is shown, a 5% discount applies to the combined fare.",
      },
      {
        question: "What if my Belfast International flight is delayed?",
        answer:
          "Share the flight number. We monitor it where possible and adjust the Glengormley collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Do you collect from Mallusk?",
        answer:
          "Yes. Include the unit or reception. A Glengormley town-centre pin is not the industrial estate.",
      },
      {
        question: "Can I book this Glengormley transfer online?",
        answer:
          "Yes. Complete the quote on this page and pay securely online where an instant fare is shown.",
      },
    ],
  ...
  {
    slug: "glengormley-to-belfast-city-airport",
    townSlug: "glengormley",
    airportCode: "BHD",
    title: "Glengormley to Belfast City Airport Taxi",
    h1: "Glengormley to Belfast City Airport Taxi",
    metaDescription:
    ...
    whyBookIntro:
      "City Airport from Glengormley is the Sandyknowes-to-Sydenham booking — a fixed price from that junction, not a Shore Road fare.",
    localAreasText:
      "Hightown Road needs the house number. Mallusk needs the unit. Carnmoney and Rathcoole should be named. Whiteabbey is a different page.",
    faqs: [
      {
        question: "How much is a taxi from Glengormley to Belfast City Airport?",
        answer:
          "Use the quote tool on this page. City Airport is already selected. Sandyknowes and Hightown are different starts, so we do not print one Glengormley fare for this terminal.",
      },
      {
        question: "How long is Glengormley to Belfast City Airport?",
        answer:
          "The usual path leaves Sandyknowes toward the city and Sydenham. It is not the Whiteabbey A2. The quote box shows the time for your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from City Airport to Glengormley?",
        answer:
          "Yes. Use Return on the quote form. Instant online return prices include a 5% discount on the combined fare where that price is shown.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Enter the Carnmoney street. It is a neighbouring district, not a Whiteabbey shore address.",
      },
      {
        question: "Can I book online from Glengormley?",
        answer:
          "Yes. The calculator is the same booking flow as the homepage, with Belfast City Airport already selected.",
      },
    ],
  ...
  {
    slug: "glengormley-to-dublin-airport",
    townSlug: "glengormley",
    airportCode: "DUB",
    title: "Glengormley to Dublin Airport Taxi",
    h1: "Glengormley to Dublin Airport Taxi",
    metaDescription:
    ...
    fromAirport:
      "Dublin Airport → Glengormley is booked as a return or a one-way inbound. We monitor the flight where possible. Complimentary waiting on airport pickups is up to 60 minutes. Share the terminal when you know it.",
    whyBookIntro:
      "A Glengormley–Dublin booking is a reserved M2 then M1 transfer, with included tolls and a fare taken from Sandyknowes, Hightown or Mallusk.",
    localAreasText:
      "Mallusk has a direct start toward the M2. Hightown is up the hill. Carnmoney and Rathcoole should be entered in full. Whiteabbey is not this junction.",
    faqs: [
      {
        question: "How much is a taxi from Glengormley to Dublin Airport?",
        answer:
          "Enter the Glengormley pickup in the quote tool — Dublin Airport is already selected. Applicable M1 tolls are included. Mallusk and Hightown are not one Sandyknowes price.",
      },
      {
        question: "How long does Glengormley to Dublin Airport take?",
        answer:
          "This is a longer reserved slot than either Belfast airport: M2 from Sandyknowes, then the M1/A1. The quote box maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Dublin Airport to Glengormley?",
        answer:
          "Yes. Select Return on the quote form. Instant online returns include a 5% combined-fare discount where that price is shown.",
      },
      {
        question: "What if my Dublin flight is delayed?",
        answer:
          "Give us the flight number. We monitor it where possible and adjust the Glengormley collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Overnight pickups from Glengormley, Hightown and Mallusk are booked on this form.",
      },
    ],
  },
  {
    slug: "whiteabbey-to-belfast-international",
    townSlug: "whiteabbey",
    airportCode: "BFS",
    title: "Whiteabbey to Belfast International Airport Taxi",
    h1: "Whiteabbey to Belfast International Airport Taxi",
    metaDescription:
    ...
    faqs: [
      {
        ...
        answer:
          "Belfast International is already selected. Enter Hazelbank, Jordanstown or Greenisland in the quote box — the shore addresses are not one Whiteabbey fare.",
      },
      {
        question: "How long does Whiteabbey to Belfast International take?",
        answer:
          "The usual path leaves the A2 and joins the M2 toward Aldergrove. The quote tool maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Aldergrove to Whiteabbey?",
        answer:
          "Yes. Choose Return on the quote form. Where an instant online price is shown, a 5% discount applies to the combined fare.",
      },
      {
        question: "What if my Belfast International flight is delayed?",
        answer:
          "Share the flight number. We monitor it where possible and adjust the Whiteabbey collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Do you collect from Jordanstown for Aldergrove?",
        answer:
          "Yes. Include the building if the pickup is on the campus. Jordanstown is the next stretch of the A2, not Sandyknowes.",
      },
      {
        question: "Can I book this Whiteabbey transfer online?",
        answer:
          "Yes. Complete the quote on this page and pay securely online where an instant fare is shown.",
      },
    ],
  ...
  {
    slug: "whiteabbey-to-belfast-city-airport",
    townSlug: "whiteabbey",
    airportCode: "BHD",
    title: "Whiteabbey to Belfast City Airport Taxi",
    h1: "Whiteabbey to Belfast City Airport Taxi",
    metaDescription:
    ...
    faqs: [
      {
        ...
        answer:
          "Use the quote tool on this page. City Airport is already selected. Hazelbank and Greenisland are different points on the A2, so we do not print one shore fare.",
      },
      {
        question: "How long is Whiteabbey to Belfast City Airport?",
        answer:
          "The usual path is the A2 along the lough toward Sydenham. The quote box shows the time for your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from City Airport to Whiteabbey?",
        answer:
          "Yes. Use Return on the quote form. Instant online return prices include a 5% discount on the combined fare where that price is shown.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Enter the Greenisland street. It is further toward Carrickfergus than Whiteabbey village.",
      },
      {
        question: "Can I book online from Whiteabbey?",
        answer:
          "Yes. The calculator is the same booking flow as the homepage, with Belfast City Airport already selected.",
      },
    ],
  ...
  {
    slug: "whiteabbey-to-dublin-airport",
    townSlug: "whiteabbey",
    airportCode: "DUB",
    title: "Whiteabbey to Dublin Airport Taxi",
    h1: "Whiteabbey to Dublin Airport Taxi",
    metaDescription:
    ...
    fromAirport:
      "Dublin Airport → Whiteabbey is booked as a return or a one-way inbound. We monitor the flight where possible. Complimentary waiting on airport pickups is up to 60 minutes. Share the terminal when you know it.",
    whyBookIntro:
      "A Whiteabbey–Dublin booking is a reserved Shore Road then A1 transfer, with included tolls and a fare taken from the lough address you enter.",
    localAreasText:
      "Hazelbank and Jordanstown are on the A2. Greenisland is further toward Carrickfergus. Rathcoole is inland. Sandyknowes is the Glengormley page, not this one.",
    faqs: [
      {
        question: "How much is a taxi from Whiteabbey to Dublin Airport?",
        answer:
          "Enter the Whiteabbey pickup in the quote tool — Dublin Airport is already selected. Applicable M1 tolls are included. Greenisland and Rathcoole are not the Hazelbank pin, so we do not publish one shore price.",
      },
      {
        question: "How long does Whiteabbey to Dublin Airport take?",
        answer:
          "This is a longer reserved slot than either Belfast airport: A2 into Belfast, then the A1/M1. The quote box maps the time from your street. Journey times are approximate and can vary depending on traffic and time of day.",
      },
      {
        question: "Can I book a return from Dublin Airport to Whiteabbey?",
        answer:
          "Yes. Select Return on the quote form. Instant online returns include a 5% combined-fare discount where that price is shown.",
      },
      {
        question: "What if my Dublin flight is delayed?",
        answer:
          "Give us the flight number. We monitor it where possible and adjust the Whiteabbey collection. Airport pickups include up to 60 minutes complimentary waiting.",
      },
      {
        question: "Are tolls included from Whiteabbey to Dublin?",
        answer:
          "Yes. Applicable M1 tolls are included in the Dublin Airport fare the quote tool shows.",
      },
      {
        question: "Do you do early Dublin pickups from the Shore Road?",
        answer:
          "Yes. Overnight Whiteabbey, Jordanstown and Greenisland pickups for first-wave Dublin flights are booked on this form.",
      },
    ],
  },
];
