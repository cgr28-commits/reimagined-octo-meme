...
const AREA_AIRPORT_SURCHARGES: Record<Area, Record<AirportCode, number>> = {
  ...
  "Belfast City Centre": { BFS: 0, BHD: 0, DUB: 50, LDY: 98 },
  ...
  Newry: { BFS: 58, BHD: 63, DUB: 40, LDY: 88 },
