...
export const TOURS: readonly Tour[] = [
  {
    ...
    price: "Get a quote",
    priceNote: "Based on estate car from Belfast. Private day trips for up to 4 passengers (Saloon or Estate).",
    highlights: [
...
export const TOUR_BENEFITS = [
  ...
  },
  {
    ...
    description:
      "Get a personalised price before you travel — via WhatsApp on mobile or by email on desktop. Quotes are fixed for your journey details.",
  },
] as const;
