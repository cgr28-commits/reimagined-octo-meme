...
/** Public path for the EMERGE Belfast taxi landing page. */
export const EMERGE_BELFAST_PATH = "/events/emerge-belfast-taxi/";

export const EMERGE_BELFAST_DESTINATION = "Boucher Playing Fields, Belfast";
