...
// Address ↔ airport: 0–4 mi → £25 journey (no embed strip)
assert.equal(calculateQuote(CITY, "BFS", S, false, {}, M4, false)!.amount, 25);
assert.equal(calculateQuote(CITY, "BHD", S, false, {}, M4, false)!.amount, 25);
