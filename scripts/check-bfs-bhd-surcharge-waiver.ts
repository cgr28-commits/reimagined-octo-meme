...
// Address ↔ airport: 0–4 mi → £28 journey (no embed strip)
assert.equal(calculateQuote(CITY, "BFS", S, false, {}, M4, false)!.amount, 28);
assert.equal(calculateQuote(CITY, "BHD", S, false, {}, M4, false)!.amount, 28);
