"""Generate navy-circle favicons (white car + green plane on blue).

Source mark is cropped from public/logo.png and placed on the brand navy
circle — the same tab/search icon used on the website, not the white-background
Google Business wordmark.
"""
...
def main() -> None:
    ...
    print("Created navy circle favicons (white car, green plane on blue):")
