...
assert.match(benefits, /<span className="hero-benefit-pound" aria-hidden="true">\s*£\s*<\/span>/);
assert.doesNotMatch(benefits, /M12\.15 2\.7c2\.55 0 4\.45 1\.7/);
assert.doesNotMatch(benefits, /strokeWidth=\{3\.4\}/);
assert.doesNotMatch(benefits, /M16\.7 7\.1C16\.05 4\.7/);
assert.doesNotMatch(benefits, /M13\.15 3\.2c1\.2 0 2\.28/);
...
assert.match(css, /font-family: var\(--font-sans\), Arial, "Helvetica Neue", Helvetica, sans-serif/);
